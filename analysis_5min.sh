...
$PYTHONPATH /home/cobs/ANALYSIS/DataProducts/getprimary.py >> $TLOG 2>&1
$DATE >> $TLOG
$ECHO "2. Automatic flags" >> $TLOG
$PYTHONPATH /home/cobs/ANALYSIS/DataProducts/flagging.py >> $TLOG 2>&1
$DATE >> $TLOG
$ECHO "3. Running magnetic analysis" >> $TLOG
$PYTHONPATH /home/cobs/ANALYSIS/DataProducts/magnetism_products.py >> $TLOG 2>&1
$DATE >> $TLOG
